...
CONFIG_PLATFORM_VITRONIC_ZYNQ = y
...
ifeq ($(CONFIG_PLATFORM_VITRONIC_ZYNQ), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
ARCH := arm
CROSS_COMPILE := arm-xilinx-linux-gnueabi-
KVER  := 3.10.0
KSRC = /home/user/ZYNQ/HwdZynqLinux
endif
...
#rtl8812au-objs := $(MODULE_NAME).o

obj-$(CONFIG_RTL8812AU) +=  $(MODULE_NAME).o
#obj-$(CONFIG_RTL8812AU) += rtl8812au.o

ccflags-y += $(EXTRA_CFLAGS) -c -D__CHECK_ENDIAN__
